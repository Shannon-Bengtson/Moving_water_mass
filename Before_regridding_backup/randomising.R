...
##############################3 set up regions    
    ...
    if (replace.EM == TRUE) {
        ...
        df.N <- df2[df2[,c("Lat")] > lat_3 & df2[,c("Lat")] < 70 & df2[,c("Ocean_depth")] > dep_3 & df2[,c("Ocean_depth")] < 3000 , ] #N EM
        df.A <- df2[df2[,c("Lat")] > -60 & df2[,("Lat")] < lat_1 & df2[,c("Ocean_depth")] > dep_3 & df2[,c("Ocean_depth")] < 6000 , ] } #A EM
    else {
            df.N <- df[df[,c("Lat")] > lat_3 & df[,c("Lat")] < 70 & df[,c("Ocean_depth")] > dep_3 & df[,c("Ocean_depth")] < 3000 , ] #N EM
            df.A <- df[df[,c("Lat")] > -60 & df[,("Lat")] < lat_1 & df[,c("Ocean_depth")] > dep_3 & df[,c("Ocean_depth")] < 6000 , ] } #A EM
